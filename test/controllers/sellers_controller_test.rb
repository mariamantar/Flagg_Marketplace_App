...
class SellersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create seller" do
    assert_difference('Seller.count') do
      post sellers_url, params: { seller: { rating: @seller.rating, user_id: @seller.user_id } }
    end
  ...
  test "should update seller" do
    patch seller_url(@seller), params: { seller: { rating: @seller.rating, user_id: @seller.user_id } }
