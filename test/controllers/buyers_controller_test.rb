...
class BuyersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create buyer" do
    assert_difference('Buyer.count') do
      post buyers_url, params: { buyer: { profile_id: @buyer.profile_id, rating: @buyer.rating, user_id: @buyer.user_id } }
    end
  ...
  test "should update buyer" do
    patch buyer_url(@buyer), params: { buyer: { profile_id: @buyer.profile_id, rating: @buyer.rating, user_id: @buyer.user_id } }
